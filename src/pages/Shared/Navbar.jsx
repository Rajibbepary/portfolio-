     ...
     <nav className="flex text-[#FFFFFF] justify-between items-center  w-full md:p-6 p-3">
        ...
        <button className="md:hidden" onClick={() => setOpen(!open)}>
            ...
            <ul className={`md:flex font-poppins duration-1000 max-sm:py-8 max-sm:px-4 max-sm:right-6 max-sm:space-y-4 ${open ? 'top-10' : '-top-60'} max-sm:bg-[#DDB166] max-sm:shadow-xl rounded-md absolute md:static gap-12 text-[15px]`}>
                ...
                <li><Link className="relative text-white text-[15px] capitalize no-underline before:absolute before:left-0 before:bottom-[-6px] before:w-0 before:h-[2px] before:bg-[#DDB166] before:transition-all before:duration-500 hover:before:w-full font-semibold">Services</Link></li>
