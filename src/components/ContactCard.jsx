...
import preson from '../assets/teacher_7162968.png'
import email from '../assets/email_552486.png'
import freelance from '../assets/employee_9157350.png'
const ContactCard = () => {
    return (
        <div className=' bg-black w-full h-[350px] py-5'>
          <div className='text-center mt-7 mb-7 '>
          <h1 className='text-5xl font-bold text-slate-50'>Contact</h1>
          <p className='text-slate-100 text-[20px] font-medium'>Are You Looking For Your Business Online Presence? I am here. 🙂</p>
          </div>
           ...
           <div className='bg-[#1C222A] px-14 py-7 flex flex-col items-center rounded-2xl'>
                <img src={preson} className='w-8 h-8 object-cover' alt="" />
            ...
            <div className='bg-[#1C222A] py-7 px-14 rounded-2xl flex flex-col items-center'>
                <img src={freelance} className='w-8 h-8 object-cover' alt="" />
            ...
            <div className='bg-[#1C222A] p-7 px-14 rounded-2xl flex flex-col items-center '>
                <img src={email} className='w-8 h-8 object-cover' alt="" />
